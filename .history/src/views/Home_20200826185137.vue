<template>
    <div class="content">
        ...
        <el-table v-loading="tableLoading" :data="tableData" style="width: 50%;position: relative;left: calc(50% - 15%);">
            >
            <el-table-column prop="name" min-width="3" label="名称">
            </el-table-column>
            <el-table-column label="切换源" min-width="3">
            ...
            <el-table-column min-width="3" label="操作">
                <template slot-scope="scope">
