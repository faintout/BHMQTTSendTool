...
<script>
    export default {
        ...
        methods: {
            ...
            //读取本地localIP
            getLocalIP(){
                this.localIP = localStorage.getItem('localIP')!=null? localStorage.getItem('localIP'):(window.location.hostname,localStorage.getItem('localIP',window.location.hostname))
            }
