<template>
    <div class="content">
        ...
        <!-- 树形表格 -->
        <el-table :data="tableData" v-if="tableData" :span-method="objectSpanMethods" ref="myTable" style="width: 100%;margin-bottom: 20px;" row-key="id"  default-expand-all :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
            <template slot="empty">
                <p>{{dataText}}</p>
            </template>
