<template>
    <div class="content">
        ...
        <!-- 树形表格 -->
        {{showData}}
        <el-table :data="tableData" :span-method="objectSpanMethods" ref="myTable" style="width: 100%;margin-bottom: 20px;" row-key="id" border default-expand-all :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
            <!-- <template slot="empty"> -->
                <!-- <p>{{dataText}}</p> -->
            <!-- </template> -->
                ...
                let self = this
                 $.ajax({
                    ...
                    success(data){
                        ...
                        console.log('this',selft.tableData);
                    },
                 })
                // $.ajax({
                //     type: "POST",
