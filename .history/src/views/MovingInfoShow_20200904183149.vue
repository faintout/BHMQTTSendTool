<template>
    <div class="content">
        ...
        <div class="content_title">
            ...
            <el-button size="mini" type="success" @click="getDeviceIndicator">刷新</el-button>
        ...
        methods: {
            ...
            getDeviceIndicator() {
                ...
                this.$nextTick(async () => {
                    ...
                    console.log('getdevice', await self.getDeviceList());
                    self.tableData = await self.getDeviceList()
                    self.tableLoading = false
                    self.timers = setInterval(() => {
                        self.getDeviceIndicator()
                    }, self.timer)
                    // self.refs.myTable.doLayout()
                })
            }
