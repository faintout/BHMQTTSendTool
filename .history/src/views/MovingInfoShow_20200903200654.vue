<template>
    <div class="content">
        ...
        <div class="content_title">
            定时刷新时间(MS),0为不刷新：<el-input style="display:inline-block;width:10%;" size="small" v-model="timer"></el-input>
        ...
        <!-- 树形表格 -->
        <el-table :data="tableData"  :span-method="objectSpanMethods" style="width: 100%;margin-bottom: 20px;" row-key="id" border default-expand-all :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
