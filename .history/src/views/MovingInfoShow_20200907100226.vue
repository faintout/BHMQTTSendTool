<template>
    <div class="content">
        ...
        <el-table :data="tableData"  ref="myTable" style="width: 100%;margin-bottom: 20px;" row-key="id" border default-expand-all :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
            <template slot="empty">
                <p>{{dataText}}</p>
            </template>
