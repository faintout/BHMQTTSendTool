<template>
    <div class="content">
        ...
        <el-table v-loading="tableLoading" :data="tableData" style="width:40%;position: relative;left: calc(50% - 15%);">
            >
            <el-table-column prop="name" min-width="1" label="名称" width="180">
            </el-table-column>
            <el-table-column label="切换源" min-width="1" width="180">
