...
<script>
    ...
    window.local = (value, key) => {
        ...
        //     }
        // }
        return key?localStorage.setItem(key, value):localStorage.getItem(key)
    }
    ...
    export default {
        ...
        methods: {
            ...
            //读取本地localIP
            getLocalIP() {
                this.localIP = local('localIP') != null ? local('localIP') : local('localIP',window.location.host)
