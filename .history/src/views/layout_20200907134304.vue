<template>
    <div>
        ...
        <router-link to="">MQTT批量下发工具</router-link>
        <router-link to="">动环指标数据展示</router-link>
...
<script>
    ...
    import MqttSendTool from './MqttSendTool'
    import MovingInfoShow from './MovingInfoShow'
    export default {
        components: {
            MqttSendTool,
            MovingInfoShow
