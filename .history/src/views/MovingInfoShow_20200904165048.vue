<template>
    <div class="content">
        ...
        <!-- 树形表格 -->
        <el-table :data="tableData" v-if="tableData" :span-method="objectSpanMethods" v-loading="tableLoading" style="width: 100%;margin-bottom: 20px;" row-key="id" border default-expand-all :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
